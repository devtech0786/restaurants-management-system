      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          >
            ...
            {/* ── Header ── */}
            <div className="bg-white dark:bg-gray-900 px-5 pt-5 pb-4 border-b border-gray-100 dark:border-gray-800 shrink-0">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="font-black text-gray-900 dark:text-white text-xl font-heading leading-none">
                      Your Cart
                    </h2>
                ...
                <div className="flex items-center gap-2">
                  {totalItems > 0 && (
                    <button
                      ...
                      className="text-xs text-red-400 hover:text-red-600 font-semibold
                        transition-colors px-3 py-1.5 rounded-xl hover:bg-red-50
                        dark:hover:bg-red-950/50 border border-red-100 dark:border-red-900/50
                  ...
                  <button
                    onClick={closeCart}
                    className="w-9 h-9 rounded-2xl bg-gray-100 dark:bg-gray-800
                      hover:bg-gray-200 dark:hover:bg-gray-700 flex items-center
                  ...
                  >
                    {!freeDelivery ? (
                      <div className="bg-gradient-to-r from-orange-50 to-amber-50
                        ...
                        border border-orange-100 dark:border-orange-900/50 rounded-2xl px-4 py-3">
                        ...
                        <div className="h-2 bg-orange-100 dark:bg-orange-900/50 rounded-full overflow-hidden">
                          <motion.div
                            initial={{ width: 0 }}
                      ...
                      <div className="bg-gradient-to-r from-green-50 to-emerald-50
                        ...
                        <div className="w-7 h-7 rounded-xl bg-green-100 dark:bg-green-900/50
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-green-500 dark:text-green-500 font-medium mt-0.5">
              ...
              {!cart?.items.length ? (
                ...
                <div className="flex flex-col items-center justify-center h-full text-center
                  ...
                  <div className="relative">
                    <div className="w-32 h-32 rounded-3xl bg-white dark:bg-gray-900
                      border border-gray-100 dark:border-gray-800 shadow-sm
                      flex items-center justify-center">
                      <ShoppingCart size={52} className="text-gray-200 dark:text-gray-700" />
                    </div>
                    <motion.div
                      animate={{ y: [0, -4, 0] }}
                      ...
                      className="absolute -top-3 -right-3 w-10 h-10 rounded-2xl bg-white
                        ...
                        shadow-md flex items-center justify-center text-xl"
                    >
                      🍔
                    </motion.div>
                    <motion.div
                  ...
                  <div className="space-y-1.5">
                    <p className="font-black text-gray-900 dark:text-white text-xl font-heading">
                      Your cart is empty
                    </p>
                    <p className="text-sm text-gray-400 dark:text-gray-500 leading-relaxed max-w-[210px] mx-auto">
                  ...
                  {cart.items.map((item) => (
                    ...
                    >
                      <div className="flex">
                        ...
                        <div className="w-1 shrink-0 bg-gradient-to-b from-brand-400 to-brand-600 rounded-l-2xl" />
                        ...
                        <div className="flex gap-4 p-4 flex-1 min-w-0">
                          ...
                          {item.menuItem.imageUrl ? (
                            ...
                            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br
                              from-brand-50 via-orange-50 to-amber-50
                              dark:from-brand-950/40 dark:via-orange-950/30 dark:to-amber-950/30
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-start justify-between gap-2">
                              <p className="font-bold text-[15px] text-gray-900 dark:text-white leading-snug">
                                {item.menuItem.name}
                              </p>
                              <button
                                onClick={() => removeItem(item.id)}
                                className="w-8 h-8 rounded-xl flex items-center justify-center
                                  shrink-0 bg-red-50 dark:bg-red-950/50 text-red-400
                            ...
                            {(Object.values(item.selectedVariants).length > 0 ||
                              ...
                              <div className="flex flex-wrap gap-1 mt-1.5">
                                ...
                                {item.selectedAddons.map((a) => (
                                  <span
                                    key={a.id}
                                    className="text-[10px] bg-brand-50 dark:bg-brand-950/50
                                      text-brand-600 dark:text-brand-400 px-2 py-0.5
                                      rounded-full font-semibold"
                                  >
                                    +{a.label}
                                  </span>
                            ...
                            <div className="flex items-end justify-between mt-3">
                              ...
                              {/* Stepper */}
                              <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-2xl p-1 gap-1.5">
                                <button
                                  onClick={() => updateQuantity(item.id, item.quantity - 1)}
                                  className="w-8 h-8 rounded-xl bg-white dark:bg-gray-700
                                    shadow-sm flex items-center justify-center
                                    hover:shadow-md transition-all active:scale-90
                                    text-gray-700 dark:text-gray-300"
                                >
                                  <Minus size={11} strokeWidth={2.5} />
                                </button>
                                <span className="text-sm font-black w-6 text-center text-gray-900 dark:text-white">
                                  {item.quantity}
                                </span>
                                <button
                                  onClick={() => updateQuantity(item.id, item.quantity + 1)}
            ...
            <AnimatePresence>
              {!!cart?.items.length && (
                <motion.div
                  ...
                  exit={{ y: 12, opacity: 0 }}
                  className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-5 pt-4 pb-6 shrink-0 space-y-4"
                >
                  {/* Bill summary */}
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl px-4 py-3.5 space-y-2.5 text-sm">
                    ...
                    <div className="flex justify-between items-center font-black text-base
                      pt-2.5 border-t border-dashed border-gray-200 dark:border-gray-700">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <button
                      ...
                      className="w-full py-3 rounded-2xl border border-gray-200 dark:border-gray-700
                        text-gray-500 dark:text-gray-400 font-semibold text-sm
